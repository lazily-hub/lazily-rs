...
impl CircuitBreakerCell {
    ...
    pub fn state_cell(&self) -> CellHandle<BreakerState> {
        self.state
    }
}
...
impl RetryPolicyCell {
    ...
    pub fn delay_cell(&self) -> CellHandle<u64> {
        self.delay
    }
}
...
impl BulkheadCell {
    ...
    pub fn permits_in_use_cell(&self) -> CellHandle<u64> {
        self.in_use
    }
}
...
impl TimeoutCell {
    ...
    pub fn is_timed_out_cell(&self) -> CellHandle<bool> {
        self.timed_out
    }
}
